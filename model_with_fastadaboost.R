...
test_adaboost<-adaboost(label~tool_name+severity+redundancy_level+neighbors+category+clang_analyzer+frama_c+cppcheck+flawfinder+warnings_in_this_file, raw_data, 10)
print("end training")
...
test_real_adaboost<-real_adaboost(label~tool_name+severity+redundancy_level+neighbors+category+clang_analyzer+frama_c+cppcheck+flawfinder+warnings_in_this_file, raw_data, 10)
print("end training")
